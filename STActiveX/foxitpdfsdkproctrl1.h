...
/////////////////////////////////////////////////////////////////////////////
// CFoxitpdfsdkproctrl1 包装器类
#import "D:\\GeAn\\39.0-腾龙汽车-签名工具\\FoxitPDFSDK_AX_Pro.ocx" no_namespace
//#import "D:\\SAMSUNG-PC\\OneDrive\\st\\sth\\FoxitPDFSDK_AX_Pro.ocx" no_namespace

class CFoxitpdfsdkproctrl1 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CFoxitpdfsdkproctrl1)
public:
	CLSID const& GetClsid()
	{
		static CLSID const clsid
			= { 0xF53B7748, 0x643C, 0x4A78, { 0x8D, 0xBC, 0x1, 0xA4, 0x85, 0x5D, 0x1A, 0x10 } };
		return clsid;
	}
